...
/// @notice The top-level contract for all Melon infrastructure that maintains registries of assets, integrations,
/// fees, policies, and funds, as well as the current versions of infrastructural contracts
